   ...
   ?>
        <table class="feature">
            <th class="title">
                <table width="100%">
                    ...
                    <tr class="spacer"></tr>
                    <tr class="details">
                        <td class="text-left"><?= $matchInfo['competition_name'].", ".$matchInfo['category'];?></td>
                        <td class="text-left" style="font-weight: bold; color: rgb(204, 85, 0); font-size: 14px">Score <?= $matchInfo['score']?></td>
        ...
        <div class="sidebets">
            ...
            <div class="sidebet-card">
                ...
                <?php if($odds['odd_value']!="NaN"):?>

                <button class="sidebet-odd <?php echo $matchInfo['match_id']; ?> <?php echo clean($matchInfo['match_id'].$odds['sub_type_id'].$odds['odd_key'].$odds['special_bet_value']);
                        ...
                        custom="<?php echo clean($matchInfo['match_id'].$odds['sub_type_id'].$odds['odd_key'].$odds['special_bet_value']); ?>"
                        target="javascript:;" id="<?php echo $matchInfo['match_id']; ?>"
